\newacronym{foss}{FOSS}{Free and Open Source Software; software that grants the user the freedoms to use, study, share, and improve the program}
...
\newglossaryentry{copyleft}{
    name={copyleft},
    description={a method for making a work free, and requiring all modified and
