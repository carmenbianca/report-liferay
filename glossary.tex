...
\newglossaryentry{upstream}{
    name={upstream},
description={anything in the supply chain that is closer to the original \glspl{author}
     or maintainers of software; or the original \glspl{author} or maintainers}
}
