...
\newglossaryentry{inbound}{
    name={inbound},
    description={third-party licenses that enter a first-party project}
}

\newglossaryentry{outbound}{
    name={outbound},
    description={licenses that are distributed to third parties along with a
    product}
}

\newglossaryentry{upstream}{
    name={upstream},
    description={the original authors or maintainers of software}
}
